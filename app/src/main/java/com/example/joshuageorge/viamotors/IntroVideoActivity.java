...
import com.example.joshuageorge.viamotors.video.DensityUtil;
import com.example.joshuageorge.viamotors.video.FullScreenVideoView;
import com.example.joshuageorge.viamotors.video.LightnessController;
import com.example.joshuageorge.viamotors.video.VolumnController;

public class IntroVideoActivity extends Activity implements OnClickListener {
    ...
    private void playVideo() {
        ...
        mVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.driver_training));
        mVideo.requestFocus();
